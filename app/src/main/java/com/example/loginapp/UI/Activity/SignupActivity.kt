...
import com.example.loginapp.data.sqlite.UsersTable.UserTableManager
import com.example.loginapp.data.sqlite.UsersTable.UserTableManagerImpl
...
class SignupActivity : AppCompatActivity() {
    ...
    private lateinit var userTableManager: UserTableManager
    ...
    private fun initializationOfViews() {
        ...
        userTableManager = UserTableManagerImpl(DatabaseHandler.getInstance(this))
    ...
    private fun checkCredentials() {
        ...
        if (!isFirstNameValid(firstName)) {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnSuccessListener { result ->
                userTableManager.addUser(FirebaseUserModel(
                    mAuth.currentUser.uid,"$firstName $lastName", email
                ))
