package com.example.loginapp.Dashboard.Activity
...
import com.example.loginapp.UI.Activity.LoginActivity
import com.example.loginapp.Dashboard.Activity.Fragments.Notes.ArchiveFragment
import com.example.loginapp.Dashboard.Activity.Fragments.Notes.HomeFragment
import com.example.loginapp.Dashboard.Activity.Fragments.Notes.NotesFragment
import com.example.loginapp.Dashboard.Activity.Fragments.Notes.SettingsFragment
import com.example.loginapp.R
import com.example.loginapp.HelperClasses.CallBack
import com.example.loginapp.Firebase.DataManager.FirebaseUserManager
import com.example.loginapp.Firebase.DataManager.Model.FirebaseUserModel
import com.example.loginapp.HelperClasses.SharedPreferenceHelper
...
class HomeDashboardActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private val homeFragment =
        HomeFragment()
    private val notesFragment =
        NotesFragment()
    private val archiveFragment =
        ArchiveFragment()
    ...
    private fun setUserProfileDetails(navigationView: NavigationView?) {
        ...
        val firebaseUserManager =
            FirebaseUserManager()
        firebaseUserManager.getUserDetails(object :
            CallBack<FirebaseUserModel?> {
